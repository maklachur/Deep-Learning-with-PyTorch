...
#model = torchvision.models.resnet50(pretrained=True)  #uncomment this line for using resnet50
...
#input_channel = model.classifier.in_features  #uncomment this line for  using resnet50
